...
const menuButtonRegister = document.querySelector('.MenuColapsado');
const navBarRegister = document.querySelector('nav');
menuButtonRegister === null || menuButtonRegister === void 0 ? void 0 : menuButtonRegister.addEventListener('click', () => {
    if (navBarRegister.style.display === 'flex') {
